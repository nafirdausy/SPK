...
while ($row = $result->fetch_object()) {
    echo "<tr>
        <td class='right'>" . (++$i) . "</td>
        <td class='center'>{$row->nama_alternatif}</td>
        <td>
        ...
        <div class='dropdown'>
            ...
            <div class='dropdown-menu' aria-labelledby='dropdownMenuButton'>
                <a class='dropdown-item' href='alternatif-edit.php?id={$row->id_alternatif}'>Edit</a>
                <a class='dropdown-item' href='alternatif-hapus.php?id={$row->id_alternatif}'>Hapus</a>
            </div>
        </div>
    </div>
        </td>
                    ...
                    <form action="alternatif-simpan.php" method="POST">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <input type="text" name="nama_alternatif" placeholder="Nama Kandidat..." class="form-control"
                                    required>
                            </div>
                        </div>
